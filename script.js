var ball = [
      ...
      "Yo mama is like a turtle - once she's on her back she cant get back up.",
    ...
    var addJoke = document.getElementById("joke");
    const randomizedJoke = ball[Math.floor(Math.random () * ball.length)]

    addJoke.innerHTML = `{"joke":"${randomizedJoke}"}`